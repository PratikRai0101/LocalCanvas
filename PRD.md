...
| T2-8 ✅ | **Voice notes pinned to canvas locations** | Records via local mic, transcribes with macOS on-device Speech recognition, and makes saved transcripts searchable |
